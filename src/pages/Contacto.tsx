...
function Contacto() {
  ...
  const posicionCentro: LatLngExpression = [42.8167, -1.65];
  ...
  const sedes = [
    { nombre: t("contact_branch_center"), lat: 42.8167, lng: -1.65 },
    { nombre: t("contact_branch_north"), lat: 42.82, lng: -1.64 },
    { nombre: t("contact_branch_south"), lat: 42.81, lng: -1.655 },
  ];

  return (
    <div
      style={{ backgroundColor: "#171616", minHeight: "100vh", color: "white" }}
    >
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to bottom, rgba(0,0,0,0.3) 0%, rgba(23,22,22,0.85) 100%)",
          }}
        />
      ...
      <Container className="py-5">
        ...
        <Row className="g-4 mb-5 justify-content-center">
          ...
          <Col xs={12} sm={6} md={4}>
            ...
            >
              <i
                className="bi bi-envelope-fill mb-3 d-block"
                style={{ fontSize: "1.8rem", color: "#2d9d9d" }}
              ></i>
              <h6
          ...
          <Col xs={12} sm={6} md={4}>
            ...
            >
              <i
                className="bi bi-telephone-fill mb-3 d-block"
                style={{ fontSize: "1.8rem", color: "#2d9d9d" }}
              ></i>
              <h6
                className="text-uppercase fw-bold mb-1"
          ...
          <Col xs={12} sm={6} md={4}>
            ...
            >
              <i
                className="bi bi-geo-alt-fill mb-3 d-block"
                style={{ fontSize: "1.8rem", color: "#2d9d9d" }}
              ></i>
              <h6
                className="text-uppercase fw-bold mb-1"
        ...
        <div
          style={{
            borderRadius: "10px",
            overflow: "hidden",
            border: "1px solid rgba(45,157,157,0.25)",
          }}
        >
